...
PARAMETER_SECTION
  ...
  vector a(1,num_apar);
  vector wtpred(1,ndata);      //predicted values for the data
...
PROCEDURE_SECTION
  ...
  a = mfexp(ln_a);
  wtpred = elem_prod(a(subject),pow(len,b));
  ...
  obj_fun = ndata*ln_sigma + sum(logwt) + 0.5*norm2(logwt-log(wtpred))/square(sigma);

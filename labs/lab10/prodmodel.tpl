...
PROCEDURE_SECTION
 ...
 //   cout << i << " " << iyr << " " << Bio(iyr,i) << endl;
  ...
  // prior on r  (turn on for second bit)
  //objfun -=  -log(2*M_PI)/2 - log(0.252) - log(0.3) - square(log_r(1)-log(0.252))/(2.0*square(0.3)) ;
 ...
 for (i=1;i<=Nsp;i++)
  ...
  if (mceval_phase())
   {
    MCMCreport << objfun << " " << r << " " << K << " " << z << " " << theta << " " << q << " " << sigma << " " << Bio(Lyear) << " " << r*K/4 << endl;
   }
